            ...
            <section class="insight-grid">
                <article class="glass-card insight-card reveal" style="--delay: 0.12s;">
                    ...
                    <div class="metric-bar">
                        ...
                        <div class="bar-track">
                            <div class="bar-fill availability" style="width: <?= $availabilityRate ?>%;"></div>
                        </div>
                    </div>
                    <div class="metric-bar">
                        ...
                        <strong><?= $utilizationRate ?>%</strong>
                        <div class="bar-track">
                            <div class="bar-fill utilization" style="width: <?= $utilizationRate ?>%;"></div>
                        </div>
                    </div>
                </article>
            ...
            <section class="glass-card section-card reveal" style="--delay: 0.26s;">
                <div class="section-head section-head-split">
                    ...
                    <form class="filter-form" method="GET">
                        <input class="form-control" type="search" name="brand" placeholder="Search brand..."
                            value="<?= htmlspecialchars($searchBrand) ?>">
                        <select class="form-select" name="status">
                            <option value="">All Statuses</option>
                            <option value="Available" <?= $searchStatus === 'Available' ? 'selected' : '' ?>>Available
                            </option>
                            <option value="Rented" <?= $searchStatus === 'Rented' ? 'selected' : '' ?>>Rented</option>
                            <option value="Maintenance" <?= $searchStatus === 'Maintenance' ? 'selected' : '' ?>>
                                Maintenance</option>
                        </select>
                        ...
                        <?php foreach ($vehicles as $index => $v): ?>
                            ...
                            <article class="vehicle-card reveal" style="--delay: <?= $delay ?>s;">
                                <div class="vehicle-media">
                                    <img src="<?= htmlspecialchars($vehicleImage) ?>"
                                        alt="<?= htmlspecialchars($v['brand'] . ' ' . $v['model']) ?>">
                                    <?php if ($needsMaintenance): ?>
                                        <span class="maintenance-flag"><i class="fas fa-triangle-exclamation"></i> Service
                                            Check</span>
                                    <?php endif; ?>
                                </div>
                                <div class="vehicle-body">
                                    ...
                                    <div class="vehicle-bottom">
                                        ...
                                        <span
                                            class="status-chip status-<?= htmlspecialchars($statusClass) ?>"><?= htmlspecialchars($v['status']) ?></span>
                                    </div>
                                </div>
