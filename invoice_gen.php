...
<head>
    ...
    <style>
        ...
        .invoice-container { background: white; width: 210mm; min-height: 297mm; margin: 20px auto; padding: 40px; box-shadow: 0 0 10px rgba(0,0,0,0.1); }
        .logo { font-size: 24px; font-weight: bold; color: #1e3c72; }
        .invoice-header { border-bottom: 2px solid #1e3c72; margin-bottom: 20px; padding-bottom: 10px; }
        .table-invoice th { background-color: #f8f9fa; }
        .signature-box { height: 100px; border: 1px dashed #ccc; margin-top: 10px; }
        @media print {
...
<div class="invoice-container">
    ...
    <table class="table table-bordered table-invoice">
        ...
        <tbody>
            <tr>
                <td>
                    Vehicle Rental: <strong><?= htmlspecialchars($invoice['brand'] . ' ' . $invoice['model']) ?></strong><br>
