...
<head>
    ...
    <style>
        ...
        body {
            ...
            /* Le fond clair de ton dashboard */
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        <?php foreach ($reservations as $row): ?>
                            <tr>
                                <td class="fw-bold text-theme-dark">INV-<?= str_pad($row['id'], 6, '0', STR_PAD_LEFT) ?>
                                </td>
                                ...
                                <td class="text-center">
                                    <a href="facture.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-outline-primary"
                                        title="View / Print">
                                    ...
                                    <a href="delete_booking.php?id=<?= $row['id'] ?>"
                                        ...
                                        onclick="return confirm('Es-tu sûr de vouloir supprimer cette facture et la réservation associée ?');"
                                        title="Delete">
